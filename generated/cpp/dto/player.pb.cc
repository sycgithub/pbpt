...
void protobuf_AssignDesc_dto_2fplayer_2eproto() {
  protobuf_AddDesc_dto_2fplayer_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "dto/player.proto");
  GOOGLE_CHECK(file != NULL);
  PlayerDto_descriptor_ = file->message_type(0);
  static const int PlayerDto_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PlayerDto, id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PlayerDto, exp_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_dto_2fplayer_2eproto);
}
...
void protobuf_AddDesc_dto_2fplayer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\004 \002(\tB \n\036com.github.zxh.pbpt.protos.dto", 119);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "dto/player.proto", &protobuf_RegisterTypes);
  PlayerDto::default_instance_ = new PlayerDto();
  PlayerDto::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_dto_2fplayer_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_dto_2fplayer_2eproto {
  StaticDescriptorInitializer_dto_2fplayer_2eproto() {
    protobuf_AddDesc_dto_2fplayer_2eproto();
  }
} static_descriptor_initializer_dto_2fplayer_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int PlayerDto::kIdFieldNumber;
const int PlayerDto::kExpFieldNumber;
...
const PlayerDto& PlayerDto::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dto_2fplayer_2eproto();
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<PlayerDto*>(16)->f) - \
